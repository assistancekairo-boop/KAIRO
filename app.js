document.addEventListener('DOMContentLoaded', () => {
  ...
  const KAIRO_MASTER_CATALOG = [
    { id: 1, brand: 'Absolut Vodka', form: 'Sippers', name: 'Absolut Vodka - Sipper • Single', price: 499, badge: 'SINGLE', quantityText: '1 Sipper • 100% Upcycled' },
    { id: 2, brand: 'Absolut Vodka', form: 'Sippers', name: 'Absolut Vodka - Sipper • Set of 2', price: 799, badge: 'SET OF 2', quantityText: '2 Sippers • 100% Upcycled' },
    { id: 3, brand: 'Absolut Vodka', form: 'Sippers', name: 'Absolut Vodka - Sipper • Set of 5', price: 1699, badge: 'SET OF 5', quantityText: '5 Sippers • 100% Upcycled' },
    { id: 4, brand: 'Absolut Vodka', form: 'Glasses', name: 'Absolut Vodka - Tumbler Glass • Single', price: 599, badge: 'SINGLE', quantityText: '1 Glass • 100% Upcycled' },
    { id: 5, brand: 'Absolut Vodka', form: 'Glasses', name: 'Absolut Vodka - Tumbler Glass • Set of 2', price: 999, badge: 'SET OF 2', quantityText: '2 Glasses • 100% Upcycled' },
  ...
  function renderGroupedResults(query, results) {
    ...
    if (matchedBrands.length > 0 || matchedForms.length > 0) {
      ...
      matchedForms.forEach(formObj => {
        ...
        const formImg = formImageMap[formObj.key] || 'images/categories/Glasses%20Collection%20.webp';
        const cardLink = document.createElement('a');
        cardLink.className = 'arrivals-card collection-card';
    ...
    if (results.length > 0) {
      ...
      Object.keys(groups).forEach(groupTitle => {
        ...
        items.forEach(item => {
          ...
          if (cardImg.endsWith('.webp')) cardImg = cardImg.replace(/\.webp$/i, '.webp');
          cardLink.innerHTML = `
            <div class="arrivals-card__img-wrapper" style="aspect-ratio: 1 / 1; width: 100%; border: 1px solid var(--Red-1); border-radius: 0.4rem; overflow: hidden; position: relative;">
        ...
        <div class="search-group__grid">
          ...
          <a href="catalog.html?form=Glasses" class="arrivals-card collection-card zero-state-card" style="text-decoration:none; color:inherit;">
            <div class="arrivals-card__img-wrapper" style="aspect-ratio: 1 / 1; width: 100%; border: 1px solid var(--Red-1); border-radius: 0.4rem; overflow: hidden; position: relative;">
              ...
              <img src="images/categories/Glasses%20Collection%20.webp" alt="GLASSES" class="arrivals-card__img" style="width: 100%; height: 100%; object-fit: cover; aspect-ratio: 1 / 1; display: block;">
            </div>
            <div class="arrivals-card__info" style="margin-top: 1.2rem;">
              <span class="arrivals-card__brand" style="color: var(--Red-Main); font-family: var(--Font-Primary); font-size: 1.6rem; font-weight: 700;">CATEGORY DIRECTORY</span>
          ...
          <a href="catalog.html?form=Sippers" class="arrivals-card collection-card zero-state-card" style="text-decoration:none; color:inherit;">
            <div class="arrivals-card__img-wrapper" style="aspect-ratio: 1 / 1; width: 100%; border: 1px solid var(--Red-1); border-radius: 0.4rem; overflow: hidden; position: relative;">
              ...
              <img src="images/categories/Sipper%20Collection.webp" alt="SIPPERS" class="arrivals-card__img" style="width: 100%; height: 100%; object-fit: cover; aspect-ratio: 1 / 1; display: block;">
            </div>
            <div class="arrivals-card__info" style="margin-top: 1.2rem;">
              <span class="arrivals-card__brand" style="color: var(--Red-Main); font-family: var(--Font-Primary); font-size: 1.6rem; font-weight: 700;">CATEGORY DIRECTORY</span>
  ...
  let s6Ticking = false;
  function requestUpdateSection6Scale() {
    if (!s6Ticking) {
      s6Ticking = true;
      requestAnimationFrame(() => {
        updateSection6Scale();
  ...
  window.addEventListener('scroll', requestUpdateSection6Scale, { passive: true });
  window.addEventListener('resize', requestUpdateSection6Scale, { passive: true });
  requestUpdateSection6Scale();
  ...
  if (modalContactForm) {
    modalContactForm.addEventListener('submit', (e) => {
      ...
      const msgEl = document.getElementById('modalCustomerMessage');
      const userMessageNotes = msgEl?.value.trim() || '';
      let subjectVal = '';
      let bodyText = '';
    ...
    btnPaySecurely?.addEventListener('click', async () => {
      ...
      try {
        ...
        const options = {
          ...
          image: 'images/Founder%20Kairo.webp',
